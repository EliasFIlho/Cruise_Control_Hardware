...
//751684/1677535/2.50/9/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "DRV8871DDARQ1" (originalName "DRV8871DDARQ1")
	...
	(compDef "DRV8871DDARQ1" (originalName "DRV8871DDARQ1") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "ILIM") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "GND_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "OUT2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "PGND") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "OUT1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VM") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "DRV8871DDARQ1"))
		...
		(attr "Mouser Part Number" "595-DRV8871DDARQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/DRV8871DDARQ1?qs=AQlKX63v8RstMGgN6CYN5Q%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "DRV8871DDARQ1")
		(attr "Description" "3.6A Automotive Brushed DC Motor Driver With Integrated Current Sensing (PWM Ctrl)")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/drv8871-q1")
		(attr "<Component Height>" "1.7")
		(attr "<STEP Filename>" "DRV8871DDARQ1.stp")
